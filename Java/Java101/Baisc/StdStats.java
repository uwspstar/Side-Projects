...
public final class StdStats {
     ...
     *
     * @param a the array
     * @return the maximum value in the array {@code a[]}; {@code Integer.MIN_VALUE}
     *         if no such value
     */
     ...
     *
     * @param a the array
     * @return the minimum value in the array {@code a[]}; {@code Integer.MAX_VALUE}
     *         if no such value
     */
     ...
     * @param lo the left endpoint of the subarray (inclusive)
     * @param hi the right endpoint of the subarray (exclusive)
     * @return the sum of all values in the subarray {@code a[lo..hi)}; {@code 0.0}
     *         if no such value
     * @throws IllegalArgumentException if {@code a} is {@code null}
     * @throws IllegalArgumentException unless
     *                                  {@code (0 <= lo) && (lo < hi) && (hi <= a.length)}
    ...
    /**
     * Plots the line segments connecting (<em>i</em>,
     * <em>a</em><sub><em>i</em></sub>) to (<em>i</em>+1,
     * <em>a</em><sub><em>i</em>+1</sub>) for each <em>i</em> to standard draw.
     *
     * @param a the array of values
     */
     ...
     * (<em>a</em><sub><em>i</em></sub>) for each <em>i</em> to standard draw.
     *
     * @param a the array of values
     */
    ...
    /**
     * Unit tests {@code StdStats}. Convert command-line arguments to array of
